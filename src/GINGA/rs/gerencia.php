...
<div style="display: block">
		...
		<div class="fm_modulos">
			<ul>
				<li><a class="selected" href="gerencia.php">Atividades</a></li>
...
?>
		...
		<div class="fm" style="height:570px; margin-top:5px;">
			<div class="fm_2" style="border: solid; background:#FFFFFF; float: left; height:450px">
				<h2 style='float:left;'>Tarefas</h2>
				<input id="view_c_tarefa" type="button" class="button_mais" style=" margin-left: -3px; width:20px; height:20px;"/>
				<select multiple id='sel_tarefas'>	
<?php
...
?>
			...
			<div class="fm_2" style="border: solid; width: 25%; background:#FFFFFF; float: left; height:450px">
				<h2 style="width: 100%;">Membro em Tarefas</h2>
				<select multiple id="membro_tarefa" style="margin-top:7px;">
<?php 
...
?>
			...
			<div class="fm_2" style="border: solid; background:#FFFFFF; float: left; width:30%; height:482px">
				<h2 style='float:left; font-size: 17px;'>Membros envolvidos neste projeto</h2>
				<input id="view_c_membro_projeto" type="button" class="button_mais" style=" margin-left: -3px; width:20px; height:20px;"/>
				<select multiple id="sel_membro_projeto" style="margin-top:7px;">
<?php
...
?>			
				<input type="button" class="button" value="Associar a Tarefa" name="associar_tarefa"/>
				</select>
			</div>
		</div>
...
?>
	...
	<div class="fm_cd" id="fm_add_membro" style="width:350px; height: 420px; display: none;">
...
?>
	...
	<div class="fm_cd" id="fm_c_membro_projeto" style="width:350px; height: 420px; display: none;">
...
?>
	...
	<div class="fm_cd_membro" id="fixa_cad" style="padding:50px; width:750px; top:50px; margin-left:-150px; display: none;">
		...
		<div>
			...
			<p>Nome:</p>
			<input style="width: 680px;" type="text" name="fixa_nome" value="<?php echo $membro_atual->nome;?>"/>
			<p>Endereço:</p>
